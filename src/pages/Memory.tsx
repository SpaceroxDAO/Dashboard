...
import {
  memoryCategoriesAtom,
  selectedMemoryIdAtom,
...
export function MemoryPage() {
  ...
  useEffect(() => {
    ...
    setContent(null);
    setExpandedIds([]);
  }, [activeAgentId, setSelectedId, setExpandedIds]);
  ...
  return (
    <PageContainer title="Memory Browser">
      <div className="min-h-[50vh] lg:h-[calc(100vh-10rem)] flex flex-col lg:flex-row gap-4">
        {/* Left panel - File Tree */}
        <div className="w-full lg:w-80 flex-shrink-0 bg-surface-elevated rounded-xl panel-glow p-3 sm:p-4 overflow-hidden flex flex-col max-h-64 lg:max-h-none">
          <div className="mb-4">
            <SearchBar
              value={searchQuery}
